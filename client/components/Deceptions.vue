<template>
    <div>
        <!-- Content -->
        <div class="content">
            <h3 class="sub"><span>Deceptions</span></h3>
            <ul class="movies">
                <li v-for="film in myDeceptions" :key="film.id" class="film">
                    ...
                    <div class="icons">
                        <i class="fas fa-thumbs-down" @click="removeFromDeception(film)"></i>
                    </div>
                </li>
            </ul>
        </div>
...
<script>
    module.exports =  {
        ...
        computed: {
            myDeceptions(){
                return this.films.filter(film => this.deceptions.indexOf(film.id) != -1)
            }
        },
        methods: {
...
<style scoped>
    ...
    .icons{
        display: flex; align-items: center; justify-content: center; padding: 10px; width: 100%;
    }
