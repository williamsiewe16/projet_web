<template>
    <div>
        <!-- Content -->
        <div class="content">
            <h3 class="sub"><span>Likes</span></h3>
            <ul class="movies">
                <li v-for="film in myLikes" :key="film.id" class="film">
                    ...
                    <div class="icons">
                        <i class="fas fa-heart" @click="dislike(film)"></i>
                    </div>
                </li>
            </ul>
        </div>
...
<script>
    module.exports =  {
        ...
        computed: {
            myLikes(){
                return this.films.filter(film => this.likes.indexOf(film.id) != -1)
            }
        },
        methods: {
